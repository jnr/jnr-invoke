...
final class FastIntMethodGenerator extends AbstractFastNumericMethodGenerator {
    private static final boolean ENABLED = getBooleanProperty("jnr.invoke.fast-int.enabled", true);
    ...
    static boolean isFastIntType(Platform platform, SignatureType type) {
